...
public class Shooter extends SubsystemBase {
  ...
  public Shooter(
    ...
    periodics.put(ShooterState.kFrontIntake, this::frontIntakePeriodic);
  ...
  public void frontIntakePeriodic() {
    m_io.setVoltage(
        ShooterConstants.kFrontIntakeVoltage.get(), ShooterConstants.kFrontIntakeVoltage.get());
  }
