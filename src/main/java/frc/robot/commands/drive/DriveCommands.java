            ...
            Commands.run(
                ...
                .finallyDo(
                    () -> {
                      ...
                      Logger.recordOutput("DriveCharacterization/WheelDelta", wheelDelta);
                      Logger.recordOutput("DriveCharacterization/GyroDelta", state.gyroDelta);
                      Logger.recordOutput("DriveCharacterization/WheelRadiusMeters", wheelRadius);
                      Logger.recordOutput(
                          "DriveCharacterization/WheelRadiusInches",
